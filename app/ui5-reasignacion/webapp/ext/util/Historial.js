/**
 * Formatters y handlers del ProcessFlow "Flujo de Aprobación" del Object Page
 * de propuesta. Copia del homónimo de ui5-aprobaciones (dos apps UI5
 * independientes, sin módulo compartido); la lógica de negocio real vive en
 * srv/domain/historial.service.js, compartido por ambas.
 *
 * Aquí solo quedan adaptaciones de tipo que OData V4 no permite del lado del
 * servidor, y el zoom del diagrama (estado de presentación puro).
 *
...
sap.ui.define([], function () {
    ...
    function _sincronizarBotones(oBarra, sNivel) {
        ...
        for (var i = 0; i < aBotones.length; i++) {
            ...
            if (oBoton.getId().indexOf("flujoAcercar") !== -1) {
                oBoton.setEnabled(sNivel !== "One");
            }
            if (oBoton.getId().indexOf("flujoAlejar") !== -1) {
